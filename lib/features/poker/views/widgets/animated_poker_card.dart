...
class AnimatedPokerCard extends StatefulWidget {
  ...
  @override
  State<AnimatedPokerCard> createState() => _AnimatedPokerCardState();
}

class _AnimatedPokerCardState extends State<AnimatedPokerCard> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant AnimatedPokerCard oldWidget) {
  ...
  Widget build(BuildContext context) {
    // Stagger entry: slide in from center of screen
    return TweenAnimationBuilder<double>(
      ...
      builder: (context, slideVal, child) {
        return Transform.translate(
          offset: Offset(
            (180 * slideVal) + (widget.index * 12.0),
            (-150 * slideVal),
          ),
          child: Transform(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          ...
          width: widget.card.rank.value >= 10 ? 1.2 : 0.8,
        ),
        boxShadow: [
          BoxShadow(
          ...
          if (widget.card.rank.value >= 10)
            ...CasinoTheme.neonGlow(color: CasinoTheme.primaryGold, radius: 1.2),
        ],
      ),
        ...
        children: [
          ...
          Center(
            child: Text(
              ...
              style: TextStyle(
                color: suitColor,
                fontSize: widget.card.rank.value >= 10 ? 22 : 18,
              ),
            ),
          ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          ...CasinoTheme.neonGlow(color: cardStyle.cardBorderColor, radius: 1.5),
        ],
      ),
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: CasinoTheme.primaryGold.withValues(alpha: 0.25),
              width: 0.5,
            ),
          ),
          child: Stack(
            alignment: Alignment.center,
            children: [
              // Geometric line patterns representing back
              Positioned.fill(
                child: CustomPaint(
